...
data <- read.table('Internode/C1+C20.csv', header = T , sep = ',')
...
data2 <- data3 %>% arrange(desc(PCC_under_C1))


write.table(data3, '/home/mpilab/GCN/Internode/C1+C20_new.csv', row.names = F , col.names = T,
            sep = ',')
