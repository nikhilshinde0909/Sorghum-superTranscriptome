flower_plot <- function(sample, value1, value2, start, a, b,  
  ...
  res <- lapply(1:n, function(t){
    ...
    text(x = 5 + 1.4 * cos((start + deg * (t - 1)) * pi / 180),
         y = 5 + 1.4 * sin((start + deg * (t - 1)) * pi / 180),
         value2[t],
         cex=0.75
    )
  ...
  plotrix::draw.circle(x = 5, y = 5, r = 1.75, col = circle_col3, border = circle_col2 )
